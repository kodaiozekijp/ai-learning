...
def main():
    parser = argparse.ArgumentParser(description="Simple command line chatbot with GPT-4.1-mini")
    ...
    initial_prompt = f"Your are a chatbot with the following personality: {args.personality}"
